...
class UserInitializer:
    ...
    def fill_directories():
        ...
        try:
            ...
            diagnoses_data = [
                {"mkb_code": "A15", "name": "Туберкулез органов дыхания, подтвержденный бактериологически и гистологически"}, {"mkb_code": "A16", "name": "Туберкулез органов дыхания, не подтвержденный бактериологически или гистологически"}, {"mkb_code": "A17", "name": "Туберкулез нервной системы"}, {"mkb_code": "A18", "name": "Туберкулез других органов"}, {"mkb_code": "A19", "name": "Милиарный туберкулез"}, {"mkb_code": "Z03", "name": "Медицинское наблюдение и оценка при подозрении на заболевание или патологическое состояние"}, {"mkb_code": "Z20.1", "name": "Контакт с больным и возможность заражения туберкулезом"}, {"mkb_code": "Y58.0", "name": "Осложнения от введения вакцины БЦЖ"}, {"mkb_code": "R76.1", "name": "Аномальная реакция на туберкулиновую пробу"}, {"mkb_code": "B90", "name": "Отдаленные последствия туберкулеза"}
            ]
